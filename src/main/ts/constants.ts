...
const CONST_DIRECTIONAL_LIGHT_FADE_OUT = 1;
const CONST_DIRECTIONAL_LIGHT_EXTRA_Z = .5;
const CONST_AMBIENT_LIGHT_INTENSITY = .1;
...
const CONST_BUILDING_SIZE_HEALTH_RATIO = 2;
