...
const CONST_FOV = CONST_DIRTY_PI/4;
...
const CONST_FRIENDLY_BRIGHT_FILL_COLOR = [.7, .7, .3];
...
const CONST_BATTERY_BOOST_ANIMATION_DURATION = 299;
const CONST_GRID_LINE_WIDTH = .02;
const CONST_WINCE_DURATION = 299;
